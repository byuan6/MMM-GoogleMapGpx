Module.register("MMM-GoogleMapGpx",{
    ...
    defaults: {
        ...
        googleurl: 'https://maps.googleapis.com/maps/api/js?key=@replacemewithgoogleapikey/&callback=gpxcallbackFromGoogle',
        marker: 'marker2',
...
window.GoogleMapGpx=self;
        ...
        if (this.gpx_json != null) {
            ...
            // window.markers=[];
            window.gpxcallbackFromGoogle=function() {
